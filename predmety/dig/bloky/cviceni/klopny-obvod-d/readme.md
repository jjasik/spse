...
2. IO 7400 (či alternativa) a IO 7404 (či alternativa)
3. Voltmetr, ohmmetr
4. Další součástky nejsou potřeba (tlačítka, rezistory a LED diody se použijí tak jak jsou na standartním nepájivém poli)

#### Cíle

1. realizujte bistabilní klopný obvod D na nepájivém poli - podrobnější schéma bude vysvětleno na tabuli!
...
3. Rozvrhněte si vhodné rozmístění součástek na nepájivém poli a při vypnutém napájení zapojte schéma pomocí propojovacích drátků (příklad rozvržení a zapojení TODO [zde](rozvrzeni.jpg), příklad schématu TODO [zde](schema.jpg))
...
1. [Klopný obvod D](https://www.vovcr.cz/odz/tech/380/page28.html#heading55)
1. [IO 7400](sn7400.pdf)
1. [IO 7404](sn7404.pdf)
